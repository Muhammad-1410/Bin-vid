...
class TestRenderConfig(unittest.TestCase):
    ...
    def test_crf_validation(self):
        ...
        # 0 and 51 are valid boundary values
    ...
    def test_font_path_validation(self):
        # Non-existent font path should raise ValueError
        with self.assertRaises(ValueError) as ctx:
            RenderConfig(
                source_path="in.mp4",
                output_path="out.mp4",
                font_path="non_existent_font_12345.ttf",
            ).validate()
        self.assertIn("font_path", str(ctx.exception))

        # Existing font path should pass
    ...
    def test_limit_validation(self):
        ...
        # None or positive integers are valid
    ...
    def test_bg_color_validation_and_parsing(self):
        ...
        cfg2.validate()
        self.assertEqual(cfg2.get_bg_bgr(), (0x30, 0x20, 0x10))
