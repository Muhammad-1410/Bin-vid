    ...
    def test_preview_atlas(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            with Image.open(out_file) as img:
                self.assertEqual(img.size, (8 * 2 * 4, 14 * 4))  # (width, height)
